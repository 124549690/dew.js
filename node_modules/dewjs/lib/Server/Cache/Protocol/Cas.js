    ...
    parse : function (chunk, i, len)
    {
        ...
        for (; i < len; i++)
        {
            ...
            switch (this._state)
            {
                ...
                case S.END : 
                  c = Data.cas(this._key, this._value, this._flags, this._exptime, this._bytes, this._cas);
                  ...
                  if (!("_isNoreply" in this))
                  {
                      ...
                      else if (c === Data.STATE.EXISTS)
                      {
                          this._socket.write("EXISTS\r\n");
                      }
                      else if (c === Data.STATE.NOT_FOUND)
                      {
